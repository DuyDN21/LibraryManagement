...
{
    internal class BorrowBookManagement
    {
        private static BorrowBookManagement instance = null;
        private static readonly object instanceLock = new object();
        private BorrowBookManagement() { }
        public static BorrowBookManagement Instance
        {
            get
            {
                lock (instanceLock)
                {
                    if (instance == null)
                    {
                        instance = new BorrowBookManagement();
                    }
                    return instance;
                }
            }
